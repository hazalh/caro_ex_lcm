...
```{r}
# remove sample_ids that we are not so sure if they match the tissue 
df_cleaned <- df_cleaned %>% dplyr::select(-"19", -"53", -"38", -"94", -"109")
...
##df_cleaned_50fallgrp <- selectGrps(df_cleaned, metadata_cleaned$tissue, 0.5, n=3)
